...
public class ListStatusAdapter extends BaseAdapter {
    ...
    public ListStatusAdapter(Context context){
        mContext=context;
        init();
    }
    ...
    public ListStatusAdapter(Context context,LinkedList<Status>  linkedList){
        mContext=context;
...
//            holder.shareDes.setVisibility(View.VISIBLE);
//            User shareUser=itemStatus.retweeted_status.user;
//            TextView shareUserName=new TextView(mContext);
//            shareUserName.setTextAppearance(mContext,R.style.share_userName);
//            shareUserName.setText("@"+shareUser.name+":");
