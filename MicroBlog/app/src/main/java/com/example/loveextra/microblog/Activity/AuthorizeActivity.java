...
public class AuthorizeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anthorize);
        init();
    }

    public void init(){
        // 获取 Token View，并让提示 View 的内容可滚动（小屏幕可能显示不全）
        toMain=new Intent(AuthorizeActivity.this,MainActivity.class);
...
//            updateTokenView(true);
    ...
    class AuthListener implements WeiboAuthListener {
        ...
        public void onCancel() {
            Toast.makeText(AuthorizeActivity.this,
                    R.string.auth_canceled, Toast.LENGTH_LONG).show();
        }
    ...
    private void updateTokenView(boolean hasExisted) {
        ...
        if (hasExisted) {
            Toast.makeText(AuthorizeActivity.this, R.string.load_success, Toast.LENGTH_LONG).show();
        }
    }
